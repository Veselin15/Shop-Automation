...
class LimitsConfig(BaseModel):
    ...
    # Предпазител за броя обяви в профила (активни и неактивни заедно).
    # Истинският лимит на Bazar.bg е друг — сто безплатни публикувания за
    # период, — и ботът го чете от самия сайт.
...
class RotationConfig(BaseModel):
    ...
    Изключено по подразбиране: Bazar.bg дава сто безплатни обяви за период,
    а всяка размяна е нова обява — изгаря една от тях.
    """
