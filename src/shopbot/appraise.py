...
Артикулът е НОВ, с етикет и оригинална опаковка — не е втора ръка. Продавачът
го купува от европейски аутлет. Питането е едно: ако тази обява стои в
Bazar.bg на посочената цена, колко е вероятно българин да я поръча в рамките
на месец-два?

Купувачът там е масов, не е моден ентусиаст. Консервативният вкус печели.

СМЪКВАЙ СИЛНО за екстравагантен вид, дори марката да е известна — известното
име не спасява модел, който никой не иска да носи:
- огледални, цветни или тъмноцветни стъкла;
- спортни рамки тип „маска", увити около лицето;
- едри лога през целия артикул или ко-брандинг с автомобилна/мото марка;
- ярки и неонови цветове, необичайни форми, силно сезонни артикули;
- артикули за тесен вкус (балаклави, сламени шапки, кърпички за джоб).

ВДИГАЙ за безрисков вид: черно, кафяво, сиво, класическа форма (авиатор,
wayfarer, класическа дамска чанта, кожен портфейл), дискретно лого.

Марката тежи само доколкото масовият българин я знае от улицата и рекламата.
Аутлетни и италиански „къщни" марки, които никой тук не е чувал, НЕ са
разпознаваеми, колкото и скъпа да е каталожната цена.

Цената съди спрямо това, което купувачът вижда за същите пари другаде.
...
def prompt_version() -> str:
    """Отпечатък на правилата. Сменените правила обезсилват старите оценки."""
